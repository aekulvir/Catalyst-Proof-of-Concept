        ...
        <div className="lg:flex lg:items-start lg:gap-6">
          {facets.map((facet) => {
            if (facet.__typename === 'BrandSearchFilter' && pageType !== 'brand') {
              return (
                <AccordionItem className="flex-1 max-w-96" key={facet.__typename} value={facet.name}>
                  <AccordionTrigger>
                    <h3>{facet.name}</h3>
                  </AccordionTrigger>
                  <AccordionContent>
            ...
            if (facet.__typename === 'ProductAttributeSearchFilter') {
              return (
                <AccordionItem className="flex-1 max-w-96" key={`${facet.__typename}-${facet.filterName}`} value={facet.name}>
                  <AccordionTrigger>
                    <h3>{facet.name}</h3>
                  </AccordionTrigger>
                  <AccordionContent>
            ...
            if (facet.__typename === 'RatingSearchFilter') {
              return (
                <AccordionItem className="flex-[2_2_0%] max-w-96 xl:flex-1" key={facet.__typename} value={facet.name}>
                  <AccordionTrigger>
                    <h3>{facet.name}</h3>
                  </AccordionTrigger>
            ...
            if (facet.__typename === 'OtherSearchFilter') {
              ...
              return (
                <AccordionItem className="flex-1 max-w-96" key={key} value={facet.name}>
                  <AccordionTrigger>
                    <h3>{facet.name}</h3>
                  </AccordionTrigger>
                  <AccordionContent>
